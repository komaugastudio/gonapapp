  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div onClick={() => setModalType('qr')} className="mt-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between cursor-pointer">
        <div className="flex items-center space-x-3"><div className="bg-blue-100 p-2 rounded-lg text-blue-600"><QrCode size={24}/></div><div><p className="font-bold">Kode QR Saya</p></div></div>
